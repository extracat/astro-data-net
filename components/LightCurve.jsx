  ...
  return (
    <div className="overflow-x-auto">
      <table className="not-prose my-1" style={{borderSpacing: '0.7em 0', marginLeft: '-0.7em', borderCollapse: 'separate'}}>
        <tbody>
          <tr>
            <th className="text-sm font-semibold text-left w-11">T</th>
          ...
          <tr>
            <th className="text-sm font-semibold text-left w-11">mag.</th>
          ...
          <tr>
            <th className="text-sm font-semibold text-left w-11">lim.</th>
